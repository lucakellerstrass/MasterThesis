...
public class HWCalibrationMachineAlternative extends AbstractCalibrationMachine implements CalibrationMachineInterface {
	 ...
	 */
	public HWCalibrationMachineAlternative(int numberOfPaths, int numberOfFactors,
	 ...
	 */
	public HWCalibrationMachineAlternative(int numberOfPaths, int numberOfFactors,
			CalibrationInformation calibrationInformation, CurveModelDataType curveModelDataType) {
		this(numberOfPaths, numberOfFactors, calibrationInformation,
	...
	/**
	 * Here the Hull White Model is calibrated and and the model parameters are
	...
	private HullWhiteModel CalibrateAndStore(double[] storedModelParameters) throws SolverException {
		...
		AbstractShortRateVolatilityModel volatilityModel = new ShortRateVolatilityModelPiecewiseConstant(
				randomVariableFactory, timeDiscretizationFromArray, volatilityDiscretization, parametersForCalibration,
				new double[] { 0.1 }, true);
