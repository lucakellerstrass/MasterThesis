 ...
 */
public class CVAandCalibrationTestForPythonExperiment {
...
//	private static  int NumberOfFactorsHW;
	...
	public CVAandCalibrationTestForPythonExperiment(String SwapName, String BuySell, int notional, double fixedRate,
...
//		this.NumberOfFactorsHW = NumberOfFactorsHW;
		...
		CVAandCalibrationTestForPythonExperiment.inputSwap = new StoredSwap(SwapName, BuySell, notional, fixedRate, referencedate,
