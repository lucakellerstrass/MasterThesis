...
public class ForwardBootstrapNew  {
                ...
                * @throws Exception
                ...
                public ForwardBootstrapNew(double interestRate, double recovery, double[] cdsSpreads, PaymentFrequency frequency) throws Exception {
                ...
                * @throws Exception
                ...
                public ForwardBootstrapNew(double interestRate, double recovery, double[] cdsSpreads, PaymentFrequency frequency,
                ...
                * @throws Exception
                ...
                public ForwardBootstrapNew(double[] discountCurve, double recovery, double[] cdsSpreads, PaymentFrequency frequency,
                ...
                */
                ...
                private void doBootstrapping() { // System.out.println("doBootstrapping()");
                               ...
                               fillMarginalDefaultProbabilities();
                ...
                * This is only provisoric!!!!!!! need to iner- and extrapolate the CDS spreads!!!

                * @TODO Do it better!

                */

                private void fillMarginalDefaultProbabilities() {

                               // The marginal default probability vector is fill until

                               int lastFilledIndex = (int) ((cdsSpreads.length)/deltaT);

                               // fill the rest via weighted moving average

                               for(int i = lastFilledIndex+1  ; i < MarginalDefaultProbability.length; i++) {
                                               ...
                                               for(int j = 2; j < i; j++) {
                                                               ...
                                                               sumValues += j*(MarginalDefaultProbability[j]-MarginalDefaultProbability[j-1]);

                                                               sumWeight += (j);

                                               }

                                               MarginalDefaultProbability[i]= MarginalDefaultProbability[i-1]+ sumValues/sumWeight;                                           
                ...
                * Returns the intern marginal default probability vector,

                 * witch corresponds to the used time discretization

                * vector[i] = default in [T_{i-1}, T_i] <br>

                * vector[0]= null <br>

                * DONT use this if you use two different time discretizations

                */

                public double[] getInternMarginalDefaultProbabilities() {
                ...
                * Returns the intern marginal default probability,
                ...
                * @param timeIndex
                ...
                public double getInternMarginalDefaultProbabilities(int timeIndex) {

                               reNewBootStrap();

                               return MarginalDefaultProbability[timeIndex];                
