...
/**
 * This class contains various different market Information sets such as normal swap volas.
 * <br>
 * This Information can be used to calibrate a short-rate model or a LIBOR Market Model. 
 * @author lucak
 *
 */
public class CalibrationInformation {
	...
	/**
	 * Constructs an instance of calibration Information using the data scope and data source Information 
	 * <br>
	 * Not all combinations will work.
	 * @param dataScope || Co-terminals, extended Co-terminals, full surface; if null, Co-Terminals
	 * @param dataSource  || example data, true market Data; if null example data is used
	 */
	public CalibrationInformation(DataScope dataScope, DataSource dataSource) {
     ...
     /**
      * Fill the Data Vectors with information based on the data scope and data source.
      * Not all combinations will work
      * @param dataScope2
      * @param dataSource2
      */
    ...
    case EXAMPLE:
    	...
    	case FullSurface:
    		//Full Volatilityy
			String[] atmExpiries3 = { "1M", "1M", "1M", "1M", "1M", "1M", "1M", "1M", "1M", "1M", "1M", "1M", "1M", "1M",
					...
					"30Y", "30Y", "30Y", "30Y" };
			String[] atmTenors3 = { "1Y", "2Y", "3Y", "4Y", "5Y", "6Y", "7Y", "8Y", "9Y", "10Y", "15Y", "20Y", "25Y", "30Y",
			...
			double[] atmNormalVolatilities3 = { 0.00151, 0.00169, 0.0021, 0.00248, 0.00291, 0.00329, 0.00365, 0.004, 0.00437,
    ...
    case FullSurface:
		...
		String[] atmTenors3 = { "1Y", "2Y", "3Y", "4Y", "5Y", "6Y", "7Y", "8Y", "9Y", "10Y", "15Y", "20Y", "25Y", "30Y",
				...
				"7Y", "8Y", "9Y", "10Y", "15Y", "20Y", "25Y", "30Y", "1Y", "2Y", "3Y", "4Y", "5Y", "6Y", "7Y", "8Y",
				"9Y", "10Y", "15Y", "20Y", "25Y", "30Y" };
		double[] atmLogVolatilities3 = {
				 0.006 , 0.0115 , 0.0149 , 0.0193 , 0.0212 , 0.0244 , 0.0256 , 0.0281 , 0.0307 , 0.0333 , 0.0336 , 0.0339 , 0.0339 , 0.0345
				 , 0.0065 , 0.0124 , 0.0146 , 0.0177 , 0.0189 , 0.0215 , 0.024 , 0.0265 , 0.0289 , 0.0315 , 0.0314 , 0.0319 , 0.0317 , 0.0327
				 , 0.0066 , 0.0122 , 0.0141 , 0.0167 , 0.0182 , 0.0206 , 0.0226 , 0.0249 , 0.0272 , 0.0295 , 0.0293 , 0.0294 , 0.0297 , 0.0301
				 , 0.0074 , 0.0129 , 0.0151 , 0.0174 , 0.0185 , 0.0207 , 0.0223 , 0.0243 , 0.0263 , 0.0284 , 0.0277 , 0.0279 , 0.0282 , 0.0288
				 , 0.0091 , 0.0154 , 0.0172 , 0.0187 , 0.0195 , 0.0212 , 0.0224 , 0.0241 , 0.0258 , 0.0277 , 0.0267 , 0.0267 , 0.027 , 0.0277
				 , 0.0113 , 0.018 , 0.0191 , 0.0202 , 0.0207 , 0.0215 , 0.023 , 0.0241 , 0.0255 , 0.0271 , 0.0259 , 0.026 , 0.0264 , 0.0269
				 , 0.0133 , 0.0199 , 0.0208 , 0.0212 , 0.0213 , 0.0217 , 0.0229 , 0.0241 , 0.0253 , 0.0264 , 0.0254 , 0.0254 , 0.0257 , 0.0262
				 , 0.0144 , 0.0208 , 0.0208 , 0.0213 , 0.0214 , 0.0218 , 0.0227 , 0.0237 , 0.0248 , 0.0259 , 0.0249 , 0.0251 , 0.0252 , 0.0257
				 , 0.0154 , 0.0213 , 0.0211 , 0.0213 , 0.0211 , 0.0214 , 0.0221 , 0.0229 , 0.0239 , 0.0251 , 0.0245 , 0.0247 , 0.0248 , 0.0252
				 , 0.0157 , 0.0212 , 0.021 , 0.0209 , 0.0207 , 0.0211 , 0.0218 , 0.0227 , 0.0236 , 0.0249 , 0.0247 , 0.0249 , 0.0251 , 0.0255
				 , 0.015 , 0.0205 , 0.0205 , 0.0208 , 0.0208 , 0.0213 , 0.0222 , 0.0231 , 0.0244 , 0.0257 , 0.0256 , 0.0257 , 0.0257 , 0.0258
				 , 0.0154 , 0.0217 , 0.0221 , 0.022 , 0.0221 , 0.0228 , 0.0237 , 0.0249 , 0.0262 , 0.0278 , 0.0275 , 0.0272 , 0.0268 , 0.0266
				 , 0.0163 , 0.0244 , 0.0248 , 0.0248 , 0.0248 , 0.0257 , 0.0269 , 0.0281 , 0.0298 , 0.0319 , 0.0311 , 0.03 , 0.0287 , 0.0271
				 };
 ...
 * @param dataSource
 */
	public void setSwapPeriodLength(double swapPeriodLength, String[] atmExpiries, String[] atmTenors, double[] atmNormalVolatilities
			, String targetVolatilityType, LocalDate referenceDate, BusinessdayCalendarExcludingTARGETHolidays cal,
			DayCountConvention_ACT_365 modelDC, DataScope dataScope, DataSource dataSource, String dataName) {
	...
	/**
	 * Get the name of the calibration data set:
	 * <br>
