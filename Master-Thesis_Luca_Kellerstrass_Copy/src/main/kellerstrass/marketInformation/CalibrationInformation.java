...
public class CalibrationInformation {
	...
	private void fillDataVectors(DataScope dataScope2, DataSource dataSource2) {
		...
		case Market23_10_2019:
			...
			double[] atmLogVolatilities3 = { 0.007, 0.0128, 0.0163, 0.0193, 0.0212, 0.0244, 0.0275, 0.0303, 0.0331,
					0.0359, 0.0362, 0.0365, 0.0366, 0.0373, 0.0069, 0.0132, 0.0152, 0.0177, 0.0189, 0.0215, 0.0245,
					0.0271, 0.0295, 0.0322, 0.0321, 0.0327, 0.0325, 0.0335, 0.0078, 0.0128, 0.0147, 0.0167, 0.0182,
					0.0206, 0.0233, 0.0256, 0.028, 0.0303, 0.0302, 0.0304, 0.0307, 0.0311, 0.0094, 0.0135, 0.0157,
					0.0174, 0.0185, 0.0207, 0.023, 0.025, 0.0271, 0.0293, 0.0286, 0.0289, 0.0292, 0.0298, 0.0116,
					0.0158, 0.0176, 0.0187, 0.0195, 0.0211, 0.0228, 0.0245, 0.0263, 0.0282, 0.0274, 0.0275, 0.0278,
					0.0286, 0.0135, 0.0185, 0.0195, 0.0201, 0.0207, 0.0219, 0.0234, 0.0245, 0.026, 0.0275, 0.0265,
					0.0267, 0.027, 0.0276, 0.0148, 0.0202, 0.0208, 0.0212, 0.0212, 0.0222, 0.0233, 0.0246, 0.0258,
					0.027, 0.026, 0.0261, 0.0263, 0.0268, 0.0158, 0.0214, 0.0213, 0.0212, 0.0213, 0.0221, 0.023, 0.0241,
					0.0252, 0.0264, 0.0254, 0.0256, 0.0258, 0.0262, 0.0158, 0.0218, 0.0215, 0.0213, 0.0211, 0.0217,
					0.0225, 0.0233, 0.0244, 0.0256, 0.025, 0.0252, 0.0253, 0.0257, 0.0152, 0.0215, 0.0213, 0.021,
					0.0208, 0.0214, 0.0222, 0.0231, 0.0241, 0.0254, 0.0252, 0.0255, 0.0256, 0.0259, 0.0157, 0.0208,
					0.0208, 0.0208, 0.0208, 0.0217, 0.0225, 0.0235, 0.0248, 0.0262, 0.0261, 0.0262, 0.0261, 0.0262,
					0.0164, 0.0219, 0.0221, 0.022, 0.022, 0.0232, 0.0242, 0.0254, 0.0267, 0.0283, 0.0281, 0.0277,
					0.0273, 0.027, 0, 0.0247, 0.0248, 0.0248, 0.0248, 0.026, 0.0272, 0.0286, 0.0302, 0.0324, 0.0315,
					0.0304, 0.0291, 0.0274 };
			...
			/*
			 * case RisingTerminals: String[] atmExpiries4 = {"1M" , "3M" , "6M" , "1Y" ,
			 * "2Y" , "3Y" , "4Y" , "5Y" , "7Y" , "10Y" , "15Y" , "20Y" , "30Y"}; String[]
			 * atmTenors4 ={ "1Y", "2Y", "3Y", "4Y", "5Y", "6Y", "7Y", "8Y", "9Y", "10Y",
			 * "15Y", "20Y", "25Y"};
			 * 
			 * double[] atmLogVolatilities4 = new double[13]; for(int i = )
			 * 
			 */
