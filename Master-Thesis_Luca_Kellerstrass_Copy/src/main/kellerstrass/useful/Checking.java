...
public class Checking {
	...
	/**
	 * Checks if the given discount factor curve makes sense and corresponds to the
	 * given TimeDiscretization. <br>
	 * If not it throws errors or changes the array (most likely the addition of the
	 * value 1.0 for t=0)
	 * 
	 * @param discountCurve
	 ...
	 * @throws Exception
	 */
	public static double[] checkDiscountCurve(double[] discountCurve, TimeDiscretization timeDiscretization2)
			throws Exception {
		...
		if (discountCurve.length == timeDiscretization2.getNumberOfTimes())/* the correspond */ {
			...
			// Check if the start value 1.0 at time 0 coulkd be missing is missing. In this
			// case we add it
