...
public class StringToUseful {
	...
	public static  DaycountConvention getDayCountFromString(String CouponConvention) {
		...
		if(CouponConvention.equals("ACT/360")^CouponConvention.equals("ACT_360")^CouponConvention.equals("ACT360")) {
			return ScheduleGenerator.DaycountConvention.ACT_360;
		}else {
			if(CouponConvention.equals("30/360")^CouponConvention.equals("30_360")^CouponConvention.equals("30360")) {
				return ScheduleGenerator.DaycountConvention.E30_360;
			}else {
				if(CouponConvention.equals("ACT/365")^CouponConvention.equals("ACT_365")^CouponConvention.equals("ACT365")) {
