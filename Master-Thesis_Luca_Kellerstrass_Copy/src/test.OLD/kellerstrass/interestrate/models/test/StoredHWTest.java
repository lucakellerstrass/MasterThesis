...
/**
 * This class Tests the serialized Hull White (simulation) model.
 * If the is no  serialized Hull White model yet, one have to perform <br>
 * @see kellerstrass.Calibration.CalibrateHullWhite
 * @author lucak
 *
 */
public class StoredHWTest {
