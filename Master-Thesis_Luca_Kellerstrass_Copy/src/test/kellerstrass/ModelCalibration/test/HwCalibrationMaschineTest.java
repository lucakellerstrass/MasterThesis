...
public class HwCalibrationMaschineTest {
	...
	public static void main(String[] args) throws SolverException, CalculationException {
		...
		System.out.println("Second via the Calibration maschine intern calibration test methode");
				CalibrationMaschineInterface HwCalibrationMaschine = new HWCalibrationMaschine (numberOfPaths, numberOfFactors, calibrationInformation1);
	...
	private static void Tester(CalibrationInformation calibrationInformation, boolean forcedCalculation) throws SolverException, CalculationException {
		...
		//Initialization
		CalibrationMaschineInterface HwCalibrationMaschine = new HWCalibrationMaschine(numberOfPaths, numberOfFactors, calibrationInformation);
