...
public class BootstrappingTestNew {
                ...
                public static void main(String[] args) throws Exception {
                                 ...
                                 ForwardBootstrapNew bootStrapper = new ForwardBootstrapNew(interestRate, Recovery, cdsSpreads, PaymentFrequency.QUATERLY,timeDiscretization );
