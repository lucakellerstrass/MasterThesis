...
public class ExposureMaschineHWTest {
	...
	private static	CalibrationInformation calibrationInformation = new CalibrationInformation(DataScope.CoTerminals, DataSource.EXAMPLE );
	...
	public static void main(String[] args) throws SolverException, CalculationException {
	    ...
	    //simulation machine
		LIBORModelMonteCarloSimulationModel simulationModel = HwCalibrationMaschine.getLIBORModelMonteCarloSimulationModel(process,forcedCalculation);
