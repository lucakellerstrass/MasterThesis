...
public class PortfolioTest {
	...
	public static void main(String[] args) throws SolverException, CalculationException {
		...
		//create a model to see how the portfolio behaves
				...
				//calibration machine
				CalibrationInformation calibrationInformation = new CalibrationInformation(DataScope.FullSurface, DataSource.EXAMPLE );
		...
		//create the exposure estimators		
				TermStructureMonteCarloProduct swapExposureEstimator = new ExposureMaschine(Swap1);
				TermStructureMonteCarloProduct PortfolioExposureEstimator = new ExposureMaschine(portfolio);
				
		//print the exposures of the single swap and the portfolio
				System.out.println("\n The expected exposure of the first swap:");
				ExposureMaschine.printExpectedExposurePaths(swapExposureEstimator, simulationModel, Swap1);
				
				System.out.println("\n The expected exposure of the second swap:");
				ExposureMaschine.printExpectedExposurePaths(PortfolioExposureEstimator, simulationModel, Swap2);
				
				System.out.println("\n The expected exposure of the Portfolio consisting of two swaps");
				ExposureMaschine.printExpectedExposurePaths(PortfolioExposureEstimator, simulationModel, portfolio);
