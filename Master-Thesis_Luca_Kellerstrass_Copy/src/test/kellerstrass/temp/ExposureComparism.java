...
public class ExposureComparism {
	...
	public static void main(String[] args) throws CalculationException, SolverException {
		...
		// process
		EulerSchemeFromProcessModel process1 = new EulerSchemeFromProcessModel(brownianMotion,
				EulerSchemeFromProcessModel.Scheme.EULER);
		EulerSchemeFromProcessModel process2 = new EulerSchemeFromProcessModel(brownianMotion,
				EulerSchemeFromProcessModel.Scheme.EULER);
		// calibration machine
		...
		CalibrationMachineInterface Model2CalibrationMaschine = new HWCalibrationMachine(numberOfPaths, 2,
