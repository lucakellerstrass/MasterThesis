...
public class LMMCalibrationCVA2 {
	...
	private static LIBORModelMonteCarloSimulationModel doATMSwaptionCalibration()
		...
		final ForwardCurve forwardCurve = curveModel
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++		
		...
		/*
		 * String[] atmExpiries = { "1M", "1M", "1M", "1M", "1M", "1M", "1M", "1M",
		 * "1M", "1M", "1M", "1M", "1M", "1M", "3M", "3M", "3M", "3M", "3M", "3M", "3M",
		 * "3M", "3M", "3M", "3M", "3M", "3M", "3M", "6M", "6M", "6M", "6M", "6M", "6M",
		 * "6M", "6M", "6M", "6M", "6M", "6M", "6M", "6M", "1Y", "1Y", "1Y", "1Y", "1Y",
		 * "1Y", "1Y", "1Y", "1Y", "1Y", "1Y", "1Y", "1Y", "1Y", "2Y", "2Y", "2Y", "2Y",
		 * "2Y", "2Y", "2Y", "2Y", "2Y", "2Y", "2Y", "2Y", "2Y", "2Y", "3Y", "3Y", "3Y",
		 * "3Y", "3Y", "3Y", "3Y", "3Y", "3Y", "3Y", "3Y", "3Y", "3Y", "3Y", "4Y", "4Y",
		 * "4Y", "4Y", "4Y", "4Y", "4Y", "4Y", "4Y", "4Y", "4Y", "4Y", "4Y", "4Y", "5Y",
		 * "5Y", "5Y", "5Y", "5Y", "5Y", "5Y", "5Y", "5Y", "5Y", "5Y", "5Y", "5Y", "5Y",
		 * "7Y", "7Y", "7Y", "7Y", "7Y", "7Y", "7Y", "7Y", "7Y", "7Y", "7Y", "7Y", "7Y",
		 * "7Y", "10Y", "10Y", "10Y", "10Y", "10Y", "10Y", "10Y", "10Y", "10Y", "10Y",
		 * "10Y", "10Y", "10Y", "10Y", "15Y", "15Y", "15Y", "15Y", "15Y", "15Y", "15Y",
		 * "15Y", "15Y", "15Y", "15Y", "15Y", "15Y", "15Y", "20Y", "20Y", "20Y", "20Y",
		 * "20Y", "20Y", "20Y", "20Y", "20Y", "20Y", "20Y", "20Y", "20Y", "20Y", "25Y",
		 * "25Y", "25Y", "25Y", "25Y", "25Y", "25Y", "25Y", "25Y", "25Y", "25Y", "25Y",
		 * "25Y", "25Y", "30Y", "30Y", "30Y", "30Y", "30Y", "30Y", "30Y", "30Y", "30Y",
		 * "30Y", "30Y", "30Y", "30Y", "30Y" }; String[] atmTenors = { "1Y", "2Y", "3Y",
		 * "4Y", "5Y", "6Y", "7Y", "8Y", "9Y", "10Y", "15Y", "20Y", "25Y", "30Y", "1Y",
		 * "2Y", "3Y", "4Y", "5Y", "6Y", "7Y", "8Y", "9Y", "10Y", "15Y", "20Y", "25Y",
		 * "30Y", "1Y", "2Y", "3Y", "4Y", "5Y", "6Y", "7Y", "8Y", "9Y", "10Y", "15Y",
		 * "20Y", "25Y", "30Y", "1Y", "2Y", "3Y", "4Y", "5Y", "6Y", "7Y", "8Y", "9Y",
		 * "10Y", "15Y", "20Y", "25Y", "30Y", "1Y", "2Y", "3Y", "4Y", "5Y", "6Y", "7Y",
		 * "8Y", "9Y", "10Y", "15Y", "20Y", "25Y", "30Y", "1Y", "2Y", "3Y", "4Y", "5Y",
		 * "6Y", "7Y", "8Y", "9Y", "10Y", "15Y", "20Y", "25Y", "30Y", "1Y", "2Y", "3Y",
		 * "4Y", "5Y", "6Y", "7Y", "8Y", "9Y", "10Y", "15Y", "20Y", "25Y", "30Y", "1Y",
		 * "2Y", "3Y", "4Y", "5Y", "6Y", "7Y", "8Y", "9Y", "10Y", "15Y", "20Y", "25Y",
		 * "30Y", "1Y", "2Y", "3Y", "4Y", "5Y", "6Y", "7Y", "8Y", "9Y", "10Y", "15Y",
		 * "20Y", "25Y", "30Y", "1Y", "2Y", "3Y", "4Y", "5Y", "6Y", "7Y", "8Y", "9Y",
		 ...
		 * "4Y", "5Y", "6Y", "7Y", "8Y", "9Y", "10Y", "15Y", "20Y", "25Y", "30Y", "1Y",
		 * "2Y", "3Y", "4Y", "5Y", "6Y", "7Y", "8Y", "9Y", "10Y", "15Y", "20Y", "25Y",
		 * "30Y" }; double[] atmNormalVolatilities = { 0.00151, 0.00169, 0.0021,
		 * 0.00248, 0.00291, 0.00329, 0.00365, 0.004, 0.00437, 0.00466, 0.00527,
		 * 0.00571, 0.00604, 0.00625, 0.0016, 0.00174, 0.00217, 0.00264, 0.00314,
		 * 0.00355, 0.00398, 0.00433, 0.00469, 0.00493, 0.00569, 0.00607, 0.00627,
		 * 0.00645, 0.00182, 0.00204, 0.00238, 0.00286, 0.00339, 0.00384, 0.00424,
		 * 0.00456, 0.00488, 0.0052, 0.0059, 0.00623, 0.0064, 0.00654, 0.00205, 0.00235,
		 * 0.00272, 0.0032, 0.00368, 0.00406, 0.00447, 0.00484, 0.00515, 0.00544,
		 * 0.00602, 0.00629, 0.0064, 0.00646, 0.00279, 0.00319, 0.0036, 0.00396,
		 * 0.00436, 0.00469, 0.00503, 0.0053, 0.00557, 0.00582, 0.00616, 0.00628,
		 * 0.00638, 0.00641, 0.00379, 0.00406, 0.00439, 0.00472, 0.00504, 0.00532,
		 * 0.0056, 0.00582, 0.00602, 0.00617, 0.0063, 0.00636, 0.00638, 0.00639,
		 * 0.00471, 0.00489, 0.00511, 0.00539, 0.00563, 0.00583, 0.006, 0.00618, 0.0063,
		 * 0.00644, 0.00641, 0.00638, 0.00635, 0.00634, 0.00544, 0.00557, 0.00572,
		 * 0.00591, 0.00604, 0.00617, 0.0063, 0.00641, 0.00651, 0.00661, 0.00645,
		 * 0.00634, 0.00627, 0.00624, 0.00625, 0.00632, 0.00638, 0.00644, 0.0065,
		 * 0.00655, 0.00661, 0.00667, 0.00672, 0.00673, 0.00634, 0.00614, 0.00599,
		 * 0.00593, 0.00664, 0.00671, 0.00675, 0.00676, 0.00676, 0.00675, 0.00676,
		 * 0.00674, 0.00672, 0.00669, 0.00616, 0.00586, 0.00569, 0.00558, 0.00647,
		 * 0.00651, 0.00651, 0.00651, 0.00652, 0.00649, 0.00645, 0.0064, 0.00637,
		 * 0.00631, 0.00576, 0.00534, 0.00512, 0.00495, 0.00615, 0.0062, 0.00618,
		 * 0.00613, 0.0061, 0.00607, 0.00602, 0.00596, 0.00591, 0.00586, 0.00536,
		 * 0.00491, 0.00469, 0.0045, 0.00578, 0.00583, 0.00579, 0.00574, 0.00567,
		 * 0.00562, 0.00556, 0.00549, 0.00545, 0.00538, 0.00493, 0.00453, 0.00435,
		 * 0.0042, 0.00542, 0.00547, 0.00539, 0.00532, 0.00522, 0.00516, 0.0051,
		 * 0.00504, 0.005, 0.00495, 0.00454, 0.00418, 0.00404, 0.00394 };
		 * 
		 */
		...
		// String[] atmTenors = {"1Y", "4Y", "6Y", "7Y", "8Y", "9Y", "10Y"}; //no
		// co-terminals
		...
		for (int i = 0; i < atmNormalVolatilities.length; i++) {
			...
			calibrationProducts.add(CurveModelCalibrationItem.createCalibrationItem(weight, exercise, swapPeriodLength,
					numberOfPeriods, moneyness, targetVolatility, targetVolatilityType, forwardCurve, discountCurve));
		...
		// TimeDiscretizationFromArray(new double[] {0, 1 ,2, 3, 5, 7, 10, 15});
		...
		// liborPeriodDiscretization, new TimeDiscretizationFromArray(0.00, 1.0, 2.0,
		// 5.0, 10.0, 20.0, 30.0, 40.0), new TimeDiscretizationFromArray(0.00, 1.0, 2.0,
		// 5.0, 10.0, 20.0, 30.0, 40.0), 0.50 / 100);
		...
		// LIBORVolatilityModel volatilityModel = new
		// LIBORVolatilityModelPiecewiseConstant(timeDiscretizationFromArray,
		// liborPeriodDiscretization, new TimeDiscretizationFromArray(0, 1 ,2, 3, 4, 5,
		// 7, 10, 15, 20, 25, 30), new TimeDiscretizationFromArray(0, 1 ,2, 3, 4, 5, 7,
		...
		for (int i = 0; i < calibrationItemNames.size(); i++) {
			calibrationItems[i] = new CalibrationProduct(calibrationProducts.get(i).getProduct(),
					calibrationProducts.get(i).getTargetValue(), calibrationProducts.get(i).getWeight());
		}

		System.out.println("liborPeriodDiscretization = " + liborPeriodDiscretization);
		System.out.println("curveModel = " + curveModel);
		System.out.println("forwardCurve = " + forwardCurve);
		System.out.println("discountCurve = " + discountCurve);
		System.out.println("calibrationItems = " + calibrationItems);
		System.out.println("properties = " + properties);

		LIBORModel liborMarketModelCalibrated = new LIBORMarketModelFromCovarianceModel(liborPeriodDiscretization,
				curveModel, forwardCurve, new DiscountCurveFromForwardCurve(forwardCurve), covarianceModelDisplaced,
		...
		for (int i = 0; i < calibrationProducts.size(); i++) {
			...
			try {
				...
				System.out.println(calibrationItemNames.get(i) + "\t" + "Model: \t" + formatterValue.format(valueModel)
		...
		System.out.println("RMS Error.....:"
				+ formatterDeviation.format(Math.sqrt(deviationSquaredSum / calibrationProducts.size())));
		System.out.println(
